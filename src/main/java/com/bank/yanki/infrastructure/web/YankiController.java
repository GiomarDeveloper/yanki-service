...
import com.bank.yanki.model.CardAssociationRequest;
import com.bank.yanki.model.CardAssociationResponse;
import com.bank.yanki.model.SendPaymentRequest;
...
/**
 * Controlador REST para la gestión de operaciones Yanki Wallet.
 *
 * <p>Esta clase implementa la interfaz {@link WalletsApi} generada por OpenAPI
 * y proporciona endpoints para la creación de wallets, asociación de tarjetas,
 * consulta de información y procesamiento de pagos.</p>
 *
 * <p>El controlador utiliza programación reactiva con Project Reactor para
 * manejar solicitudes de manera no bloqueante y eficiente.</p>
 *
 */
@Slf4j
@RestController
...
public class YankiController implements WalletsApi {
  ...
  @Override
  public Mono<ResponseEntity<CardAssociationResponse>> associateCard(
    Mono<CardAssociationRequest> cardAssociationRequest, ServerWebExchange exchange) {
  ...
  @Override
  public Mono<ResponseEntity<YankiWalletResponse>> createWallet(
    Mono<YankiWalletRequest> yankiWalletRequest, ServerWebExchange exchange) {
  ...
  @Override
  public Mono<ResponseEntity<YankiWalletResponse>> getWalletByPhone(String phoneNumber,
    ...
    return sendPaymentRequest
      ...
      .doOnSuccess(response -> {
        if (response.getStatusCode() == HttpStatus.ACCEPTED) {
          log.info("Payment validation in progress - TransactionId: {}",
